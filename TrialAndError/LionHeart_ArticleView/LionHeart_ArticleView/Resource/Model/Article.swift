...
extension Article {
    static func datas() -> [ArticleContentType] {
        return [
            ...
            .content("아기가 충분히 먹었고, 기저귀도 젖지 않았다면, 오히려 이럴 때는 진정 계단을 참고해 정적인 방법으로 아기를 진정시켜주는 것이 좋다. 온종일 아기가 힘들었다는 것을 알아주고, 아기의 마음을 이해해줄 수 있는 여러분이 든든하게 존재한다는 느낌을 전해주면 된다."),
            ...
            .block("블럭입니다블럭입니다블럭입니다블럭입니다블럭입니다블럭입니다블럭입니다블럭입니다블럭입니다블럭입니다블럭입니다블럭입니다블럭입니다블럭입니다블럭입니다블럭입니다"),
